...
public class ServerMain {
    ...
    //tell everyone that the user has disconnected and regenerates the the user list
    ...
    // goes through array list does certain things for each item in list i.e. print message, 
